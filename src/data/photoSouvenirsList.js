...
const photoSouvenirsList = [
    {
        ...
        services: [
                ...
                products: [
                    {
                        options: [
                            {
                                subtitle: 'Кружка белая снаружи',
                                price: '700р'
                            },
                            {
                                subtitle: 'Кружка-хамелеон',
                                price: '950р'
                            },
                            {
                                subtitle: 'Кружка с ложкой',
                                price: '820р'
                            },
                            {
                                subtitle: 'Кружка матовая/стеклянная',
                                price: '550р'
                            },
                            {
                                subtitle: 'Бутылка металлическая',
                                price: '1300р'
                            },
                            {
                                subtitle: 'Кружка пивная',
                                price: '1200р'
                            },
                            {
                                subtitle: 'Термокружка',
                                price: '1200р'
                            },
                            {
                                subtitle: 'Термос металлический',
                                price: '1790р'
                            },
                        ],
                ...
                products: [
                    {
                        options: [
                            {
                                subtitle: 'Футболка белая (с одной стороны)',
                                price: 'от 1500р'
                            },
                            {
                                subtitle: 'Печать на черной/цветной футболке',
                                price: 'от 800р'
                            },
                            {
                                subtitle: 'Печать на своей белой футболке',
                                price: '600р'
                            },
                            {
                                subtitle: 'Дополнительный отпечаток',
                                price: '200р'
                            },
                            {
                                subtitle: 'Толстовка',
                ...
                products: [
                    {
                        options: [
                            ...
                            {
                                subtitle: 'Пазл сердце',
                                price: '700р'
                            },
                            {
                                subtitle: 'Магнитный пазл 13х18',
                                price: '570р'
                            },
                            {
                                subtitle: 'Манитный пазл А4',
                                price: '850р'
                            },
                            {
                                subtitle: 'Магнитный пазл сердце',
                                price: '750р'
                            },
                            {
                                subtitle: 'Пазл золото/серебро А4',
                                price: '700р'
                            },
                            {
                                subtitle: 'Пазл золото/серебро А3',
                                price: '1000р'
                            },
                            {
                                subtitle: 'Пазл золото/серебро сердце',
                                price: '650р'
                            },
                        ]
                    },
                ...
                products: [
                    {
                        options: [
                            {
                                subtitle: 'Детская подушка',
                                price: '700р'
                            },
                            {
                                subtitle: 'Плюшевая подушка',
                                price: '1100р'
                            },
                            {
                                subtitle: 'Атласная подушка',
                                price: '1200р'
                            },
                            {
                                subtitle: 'Подушка с кантом',
                                price: '1400р'
                            },
                            {
                                subtitle: 'Детская с узором',
                                price: '1400р'
                            },
                            {
                                subtitle: 'Льняная подушка',
                                price: '1400р'
                            },
                            {
                                subtitle: 'Подушка с сердцем',
                                price: '1500р'
                            },
                            {
                                subtitle: 'Подушка с бахромой',
                                price: '1600р'
                            },
                            {
                                subtitle: 'Подушка с рюшами',
                                price: '1600р'
                            },
                            {
                                subtitle: 'Подушка с пайетками',
                                price: '1700р'
                            },
                        ]
                    },
            ...
            },
            {
                ...
                sideImages: [Polaroid_5, Polaroid_6],
            }
...
export default photoSouvenirsList;